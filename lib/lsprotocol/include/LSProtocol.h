 ...
 * @since 3.16.0
 */
enum class SemanticTokenModifiers : std::uint16_t {
...
namespace lsp {
inline const std::vector<std::string_view> kBuiltinSemanticTokenTypes{
...
namespace lsp {
inline const std::vector<std::string_view> kBuiltinSemanticTokenModifiers{
